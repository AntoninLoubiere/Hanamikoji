...
std::vector<CxxType> python_to_cxx_array(PyObject* in)
{
    ...
    for (unsigned int i = 0; i < size; ++i)
        out.push_back(
            python_to_cxx<PyObject*, CxxType>(PyList_GET_ITEM(in, i)));
...
static PyObject* p_nb_cartes_validees(PyObject* /* self */, PyObject* args)
{
    ...
    try
    {
        return cxx_to_python<PyObject*, int>(
            api_nb_cartes_validees(python_to_cxx<PyObject*, joueur>(arg_j),
                                   python_to_cxx<PyObject*, int>(arg_g)));
    }
    catch (...)
    {
        return nullptr;
...
static PyObject* p_possession_geisha(PyObject* /* self */, PyObject* args)
{
    ...
    try
    {
        return cxx_to_python<PyObject*, joueur>(
            api_possession_geisha(python_to_cxx<PyObject*, int>(arg_g)));
    }
    catch (...)
    {
        return nullptr;
...
static PyObject* p_est_jouee_action(PyObject* /* self */, PyObject* args)
{
    ...
    try
    {
        return cxx_to_python<PyObject*, bool>(
            api_est_jouee_action(python_to_cxx<PyObject*, joueur>(arg_j),
                                 python_to_cxx<PyObject*, action>(arg_a)));
    }
    catch (...)
    {
        return nullptr;
...
static PyObject* p_nb_cartes(PyObject* /* self */, PyObject* args)
{
    ...
    {
        return cxx_to_python<PyObject*, int>(
            api_nb_cartes(python_to_cxx<PyObject*, joueur>(arg_j)));
    }
    catch (...)
    {
        return nullptr;
...
static PyObject* p_action_valider(PyObject* /* self */, PyObject* args)
{
    ...
    try
    {
        return cxx_to_python<PyObject*, error>(
            api_action_valider(python_to_cxx<PyObject*, int>(arg_c)));
    }
    catch (...)
    {
        return nullptr;
...
static PyObject* p_action_defausser(PyObject* /* self */, PyObject* args)
{
    ...
    {
        return cxx_to_python<PyObject*, error>(
            api_action_defausser(python_to_cxx<PyObject*, int>(arg_c1),
                                 python_to_cxx<PyObject*, int>(arg_c2)));
    }
    catch (...)
    {
        return nullptr;
...
static PyObject* p_action_choix_trois(PyObject* /* self */, PyObject* args)
{
    ...
    {
        return cxx_to_python<PyObject*, error>(
            api_action_choix_trois(python_to_cxx<PyObject*, int>(arg_c1),
                                   python_to_cxx<PyObject*, int>(arg_c2),
                                   python_to_cxx<PyObject*, int>(arg_c3)));
    }
    catch (...)
    {
        return nullptr;
...
static PyObject* p_action_choix_paquets(PyObject* /* self */, PyObject* args)
{
    ...
    PyObject* arg_p2c1;
    PyObject* arg_p2c2;
    if (!PyArg_ParseTuple(args, "OOOO", &arg_p1c1, &arg_p1c2, &arg_p2c1,
                          &arg_p2c2))
    {
        return nullptr;
    }
    ...
    {
        return cxx_to_python<PyObject*, error>(
            api_action_choix_paquets(python_to_cxx<PyObject*, int>(arg_p1c1),
                                     python_to_cxx<PyObject*, int>(arg_p1c2),
                                     python_to_cxx<PyObject*, int>(arg_p2c1),
                                     python_to_cxx<PyObject*, int>(arg_p2c2)));
    }
    catch (...)
    {
        return nullptr;
...
static PyObject* p_repondre_choix_trois(PyObject* /* self */, PyObject* args)
{
    ...
    {
        return cxx_to_python<PyObject*, error>(
            api_repondre_choix_trois(python_to_cxx<PyObject*, int>(arg_c)));
    }
    catch (...)
    {
        return nullptr;
...
static PyObject* p_repondre_choix_paquets(PyObject* /* self */, PyObject* args)
{
    ...
    {
        return cxx_to_python<PyObject*, error>(
            api_repondre_choix_paquets(python_to_cxx<PyObject*, int>(arg_p)));
    }
    catch (...)
    {
        return nullptr;
...
static PyObject* p_afficher_action_jouee(PyObject* /* self */, PyObject* args)
{
    ...
    try
    {
        (api_afficher_action_jouee(
            python_to_cxx<PyObject*, action_jouee>(arg_v)));
        Py_RETURN_NONE;
    }
    catch (...)
    {
...
static PyMethodDef api_callback[] = {
    ...
    {"nb_cartes_validees", p_nb_cartes_validees, METH_VARARGS,
     "nb_cartes_validees"},
